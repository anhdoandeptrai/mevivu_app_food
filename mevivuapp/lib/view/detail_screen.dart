...
class DetailScreen extends StatelessWidget {
  ...
  Widget _buildDetailContent(BuildContext context) {
    ...
    final Recipe fullRecipe = controller.currentRecipe.value ?? recipe;
                ...
                Row(
                  children: [
                    ...
                    Obx(() => IconButton(
                          ...
                          onPressed: () => controller.toggleSave(fullRecipe),
                        )),
                  ],
                ),
  ...
  void _scrollToInstructions(BuildContext context) {
    controller.changeTab(1); // Switch to instructions tab
  }

  // Add this method to your DetailScreen class
  String getIngredientImageUrl(String ingredient) {
    // TheMealDB provides images for ingredients using this format:
    // We need to ensure the ingredient name is properly formatted for the URL
